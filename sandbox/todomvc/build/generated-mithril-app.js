...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(28).setImmediate, __webpack_require__(4)))
...
var combine = __webpack_require__(8).combine
...
var view_mithril_1 = __webpack_require__(31);
var view_mithril_2 = __webpack_require__(33);
var view_mithril_3 = __webpack_require__(34);
...
exports.view = function (model, update) {
    return m("div", [
        m("section.todoapp", [
            view_mithril_2.view(model, update),
            view_mithril_3.view(model, update),
            view_mithril_1.view(model, update),
        ]),
        info
    ]);
};
...
var actions = {
    ...
    filterBy: function (update, filterBy) { return function () { return triggerRouteChange(update, "/" + filterBy); }; }
};
exports.view = function (model, update) {
...
exports.view = function (model, update) {
    return m("header.header", [
        ...
        m("input.new-todo", {
            ...
            onkeyup: actions_1.actions.newTodoKeyUp(update)
        })
    ]);
};
...
var m = __webpack_require__(0);
var actions_1 = __webpack_require__(3);
var view_mithril_1 = __webpack_require__(39);
exports.view = function (model, update) {
    return m("section.main", [
        m("input.toggle-all", {
            type: "checkbox",
            checked: model.allCompleted,
            onchange: actions_1.actions.toggleAllTodos(update)
        }),
        m("label", { for: "toggle-all" }, "Mark all as complete"),
        m("ul.todo-list", model.todoIds.map(view_mithril_1.view(model, update)))
    ]);
};
...
exports.view = function (todo, update) {
    return m("input.edit", {
        type: "text",
        value: todo.title,
        onkeyup: actions_1.actions.editKeyUp(update, todo.id), onblur: actions_1.actions.editBlur(update, todo.id),
...
var state_1 = __webpack_require__(9);
var view_mithril_1 = __webpack_require__(36);
exports.view = function (model, update) { return function (todoId) {
    ...
    return m("li", { class: display_1.getTodoClasses(model, todo) }, [
        m("div.view", [
            m("input.toggle", {
                type: "checkbox",
                checked: todo.completed,
                onchange: actions_1.actions.toggleTodo(update, todo.id)
            }),
            m("label", { ondblclick: actions_1.actions.editTodo(update, todo) }, todo.title),
            m("button.destroy", { onclick: actions_1.actions.deleteTodo(update, todo.id) })
        ]),
        editing ? view_mithril_1.view(model.editTodo, update) : null
    ]);
}; };
...
var view_mithril_1 = __webpack_require__(16);
var meiosis_1 = __webpack_require__(12);
var meiosisTracer = __webpack_require__(11);
var app_1 = __webpack_require__(15);
var todo_storage_1 = __webpack_require__(1);
var actions_1 = __webpack_require__(3);
function startApp(view) {
    todo_storage_1.todoStorage.loadAll().then(function (todos) {
        var modelChanges = stream();
        var extractRoute = function (hash) { return (hash && hash.substring(2)) || ""; };
        var initialModel = {
            editTodo: {},
            newTodo: "",
        ...
        var model = scan(meiosis_1.applyModelChange, initialModel, modelChanges);
        var state = model.map(app_1.app.state);
        var element = document.getElementById("app");
        var mRoute = m.route;
        mRoute.prefix("#");
        var render = function () { return view(state(), modelChanges); };
        var displayTodos = actions_1.actions.displayTodos(modelChanges);
        var setRoute = function (update, path) { return update(function (model) {
            model.route = path;
            return model;
        }); };
        mRoute(element, "/", {
            "/": {
                onmatch: function (args, path) { return setRoute(modelChanges, path) && todo_storage_1.todoStorage.loadAll().then(displayTodos); },
                render: render
            },
            "/active": {
                onmatch: function (args, path) { return setRoute(modelChanges, path) && todo_storage_1.todoStorage.filter("active").then(displayTodos); },
                render: render
            },
            "/completed": {
                onmatch: function (args, path) { return setRoute(modelChanges, path) && todo_storage_1.todoStorage.filter("completed").then(displayTodos); },
                render: render
            }
        });
        state.map(m.redraw);
        meiosis_1.trace({ streamLibrary: { stream: stream }, modelChanges: modelChanges, streams: [model, state] });
        meiosisTracer({ selector: "#tracer" });
    });
}
exports.startApp = startApp;
startApp(view_mithril_1.view);
