...
(function(root, factory) {
  if (typeof define === "function" && define.amd) {
    define(["meiosis", "../../common/main/actions", "../../common/main/state", "../../common/main/display", "../../common/main/receive", "./view", "./ready", "../todoItem/component"], function(meiosis, mainActions, mainState, mainDisplay, mainReceive, mainView, mainReady, todoItemComponent) {
