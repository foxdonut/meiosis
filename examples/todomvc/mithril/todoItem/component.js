...
(function(root, factory) {
  if (typeof define === "function" && define.amd) {
    define(["meiosis", "../../common/todoItem/actions", "../../common/todoItem/state", "../../common/todoItem/display", "./view", "../../common/todoItem/receive", "../todoEdit/component"], function(meiosis, todoItemActions, todoItemState, todoItemDisplay, todoItemView, todoItemReceive, todoEditComponent) {
