...
var loadAll = function () {
    return new es6_promise_1.Promise(function (resolve) {
        return setTimeout(function () { return resolve(JSON.parse(localStorage.getItem(STORAGE_KEY) || "[]")); }, 10);
    });
};
var saveAll = function (todos) {
    return new es6_promise_1.Promise(function (resolve) {
...
exports.todoStorage = {
    clearCompleted: function () {
        return new es6_promise_1.Promise(function (resolve) {
            return loadAll().then(function (todos) {
                var updatedTodos = [];
                for (var i = 0, t = todos.length; i < t; i++) {
                ...
                saveAll(updatedTodos).then(function () { return resolve(updatedTodos); });
            });
        });
    },
        ...
        return new es6_promise_1.Promise(function (resolve, reject) {
            return loadAll().then(function (todos) {
                ...
                if (index >= 0) {
                    ...
                    saveAll(todos).then(function () { return resolve(); });
                }
                else {
                    reject();
                }
    ...
    filter: function (by) {
        var completedSelected = by === "completed";
        var filterBy = function (todo) { return (!!todo.completed) === completedSelected; };
        return new es6_promise_1.Promise(function (resolve) {
            return loadAll().then(function (todos) {
                var filteredTodos = todos.filter(filterBy);
    ...
    saveTodo: function (todo) {
        return new es6_promise_1.Promise(function (resolve) {
            return loadAll().then(function (todos) {
                ...
                saveAll(todos).then(function () { return resolve(todo); });
            });
        });
    },
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.state = {
    editing: function (model, todo) { return (todo.id === model.editTodo.id); }
};
...
var storage_1 = __webpack_require__(56);
var state_1 = __webpack_require__(38);
var view_1 = __webpack_require__(39);
exports.app = {
    create: function (update, events) {
        storage_1.storage.create(update, events.storage);
        var components = {
            footer: footer_1.footer.create(update, events.footer),
            header: header_1.header.create(update, events.header),
            main: main_1.main.create(update, events.main)
        };
        router_1.router.create(update, events.router);
        return view_1.createView(components);
    },
    state: state_1.state,
    events: {
        footer: footer_1.footer.events,
        header: header_1.header.events,
        main: main_1.main.events,
        router: router_1.router.events,
        storage: storage_1.storage.events
    }
};
...
var _curry2 = __webpack_require__(32);
...
Object.defineProperty(exports, "__esModule", { value: true });
var allCompleted = function (viewModel) {
    var result = true;
    for (var i = 0, t = viewModel.todoIds.length; i < t; i++) {
...
exports.state = function (model) {
    var viewModel = JSON.parse(JSON.stringify(model));
    ...
    var notCompleted = function (todoId) { return !viewModel.todosById[todoId].completed; };
    var itemsLeft = viewModel.todoIds.filter(notCompleted).length;
...
Object.defineProperty(exports, "__esModule", { value: true });
var h_1 = __webpack_require__(0);
var info = h_1.default("footer.info", [
    h_1.default("p", "Double-click to edit a todo"),
    h_1.default("p", [
        h_1.default("span", "Meiosis - Created by "),
        h_1.default("a", { attrs: { href: "http://twitter.com/foxdonut00" } }, "foxdonut00")
    ]),
    h_1.default("p", [
        h_1.default("span", "Part of "),
        h_1.default("a", { attrs: { href: "http://todomvc.com" } }, "TodoMVC")
    ])
]);
exports.createView = function (components) {
    return function (model) {
        return h_1.default("div", [
            h_1.default("section.todoapp", [
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.createActions = function (events) { return ({
    clearCompleted: function () { return events.clearCompleted(true); },
    filterBy: function (filterBy) { return function () { return events.routeChange("/" + filterBy); }; }
}); };
...
var routes_1 = __webpack_require__(42);
var view_1 = __webpack_require__(43);
exports.footer = {
    create: function (update, events) {
        routes_1.createRoutes(events);
        var actions = actions_1.createActions(events);
        return view_1.createView(actions);
    },
    events: {
...
Object.defineProperty(exports, "__esModule", { value: true });
var crossroads = __webpack_require__(5);
exports.createRoutes = function (events) {
...
exports.createView = function (actions) { return function (model) {
    return h_1.default("footer.footer", [
        h_1.default("span.todo-count", model.itemsLeftText),
        h_1.default("ul.filters", [
            h_1.default("li", h_1.default("a", { attrs: { href: "#/" }, class: { selected: model.allSelected } }, "All")),
            h_1.default("li", h_1.default("a", { attrs: { href: "#/active" }, class: { selected: model.activeSelected } }, "Active")),
            h_1.default("li", h_1.default("a", { attrs: { href: "javascript://" }, on: { click: actions.filterBy("completed") },
                class: { selected: model.completedSelected } }, "Completed"))
        ]),
        model.clearCompletedVisible ?
            h_1.default("button.clear-completed", { on: { click: actions.clearCompleted } }, "Clear completed")
            : h_1.default("span")
    ]);
}; };
...
Object.defineProperty(exports, "__esModule", { value: true });
var ENTER_KEY = 13;
exports.createActions = function (updates, events) {
    var saveNewTodo = function (rawTitle) {
        var title = rawTitle.trim();
        if (title) {
            events.saveNewTodo({ title: title });
        }
    };
    ...
    var newTodoKeyUpEnterOnly = function (evt) {
        if (evt.keyCode === ENTER_KEY || evt.which === ENTER_KEY) {
            saveNewTodo(evt.currentTarget.value);
        }
    };
    var newTodoChange = function (evt) {
        return updates.editingNewTodo(evt.currentTarget.value);
    };
    return {
        newTodoKeyUp: newTodoKeyUp,
        newTodoKeyUpEnterOnly: newTodoKeyUpEnterOnly,
        newTodoChange: newTodoChange
    };
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var actions_1 = __webpack_require__(44);
var listeners_1 = __webpack_require__(46);
var updates_1 = __webpack_require__(47);
var view_1 = __webpack_require__(48);
exports.header = {
    create: function (update, events) {
        var updates = updates_1.createUpdates(update);
        listeners_1.createListeners(updates, events);
        var actions = actions_1.createActions(updates, events);
        return view_1.createView(actions);
    },
    events: {
        emit: ["saveNewTodo"],
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.createListeners = function (updates, events) {
...
exports.createUpdates = function (update) { return ({
    editingNewTodo: function (title) {
        return update(function (model) { return _.set(model, "newTodo", title); });
    },
...
var h_1 = __webpack_require__(0);
exports.createView = function (actions) { return function (model) {
    return h_1.default("header.header", [
        h_1.default("h1", "todos"),
        h_1.default("input.new-todo", {
...
Object.defineProperty(exports, "__esModule", { value: true });
var meiosis_1 = __webpack_require__(16);
var flyd = __webpack_require__(14);
var meiosisTracer = __webpack_require__(15);
var app_1 = __webpack_require__(22);
var todo_storage_1 = __webpack_require__(4);
var snabbdom_1 = __webpack_require__(21);
var attributes_1 = __webpack_require__(17);
var class_1 = __webpack_require__(18);
var eventlisteners_1 = __webpack_require__(19);
var props_1 = __webpack_require__(20);
...
var render = function (element, nextView) {
    if (currentView === null) {
...
todo_storage_1.todoStorage.loadAll().then(function (todos) {
    var update = flyd.stream();
    var eventStream = flyd.stream();
    var events = meiosis_1.createEvents({
        eventStream: eventStream,
        events: app_1.app.events,
        connect: {
    ...
    var initialModel = {
        ...
        newTodo: "",
        route: "",
        todoIds: todos.map(function (todo) { return todo.id; }),
        todosById: todos.reduce(function (acc, todo) {
            acc[todo.id] = todo;
            return acc;
        }, {})
    };
    var model = flyd.scan(meiosis_1.applyUpdate, initialModel, update);
    var viewModel = model.map(app_1.app.state);
    var view = app_1.app.create(update, events);
    var element = document.getElementById("app");
    viewModel.map(function (state) { return render(element, view(state)); });
    meiosis_1.trace({ update: update, dataStreams: [model, viewModel], otherStreams: [eventStream] });
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.createActions = function (updates, events) { return ({
    toggleAllTodos: function (evt) { return events.toggleAllTodos(evt.target.checked); }
}); };
...
Object.defineProperty(exports, "__esModule", { value: true });
var todoItem_1 = __webpack_require__(64);
var actions_1 = __webpack_require__(50);
var listeners_1 = __webpack_require__(52);
var updates_1 = __webpack_require__(53);
...
exports.main = {
    create: function (update, events) {
        ...
        var actions = actions_1.createActions(updates, events);
        var components = {
            todoItem: todoItem_1.todoItem.create(update, events.todoItem)
        };
        return view_1.createView(actions, components);
    },
    events: {
        emit: ["toggleAllTodos"],
        listen: ["onDisplayTodos", "onUpdateTodo"],
        todoItem: todoItem_1.todoItem.events
    }
};
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.createUpdates = function (update) { return ({
    displayTodos: function (todos) { return update(function (model) {
        model.todoIds = [];
        model.todosById = {};
        todos.forEach(function (todo) {
            model.todoIds.push(todo.id);
    ...
    updateTodo: function (todo) { return update(function (model) {
        model.todosById[todo.id] = todo;
        model.editTodo = {};
        return model;
    }); }
...
Object.defineProperty(exports, "__esModule", { value: true });
var h_1 = __webpack_require__(0);
exports.createView = function (actions, components) { return function (model) {
    return h_1.default("section.main", [
        h_1.default("input.toggle-all", {
            attrs: { type: "checkbox" },
            on: { change: actions.toggleAllTodos },
            props: { checked: model.allCompleted }
        }),
        h_1.default("label", { attrs: { for: "toggle-all" } }, "Mark all as complete"),
        h_1.default("ul.todo-list", model.todoIds.map(components.todoItem(model)))
    ]);
}; };
...
Object.defineProperty(exports, "__esModule", { value: true });
var crossroads = __webpack_require__(5);
var createBrowserHistory_1 = __webpack_require__(27);
var _ = __webpack_require__(1);
var extractRoute = function (hash) { return (hash && hash.substring(1)) || "/"; };
var triggerRouteChange = function (update, route) {
    update(function (model) { return _.set(model, "route", route); });
...
exports.router = {
    create: function (update, events) {
        ...
        history.listen(function (location) {
            var route = extractRoute(location.hash);
            triggerRouteChange(update, route);
        });
        crossroads.parse(extractRoute(window.location.hash));
        events.onRouteChange.map(function (route) { return triggerRouteChange(update, route); });
    },
    events: {
...
Object.defineProperty(exports, "__esModule", { value: true });
var listeners_1 = __webpack_require__(57);
exports.storage = {
    create: function (update, events) {
        listeners_1.createListeners(events);
    },
    events: {
...
exports.createListeners = function (events) {
    events.onClearCompleted.map(function () {
        util_1.todoStorage.clearCompleted().then(events.displayTodos);
    });
    events.onDeleteTodoId.map(function (todoId) {
        util_1.todoStorage.deleteTodoId(todoId).then(function () { return events.deleteTodoId(todoId); });
    });
    events.onFilter.map(function (filterBy) {
        util_1.todoStorage.filter(filterBy).then(events.displayTodos);
    });
    events.onLoadAll.map(function () {
        util_1.todoStorage.loadAll().then(events.displayTodos);
    });
    events.onSaveNewTodo.map(function (todo) {
        util_1.todoStorage.saveTodo(todo).then(events.saveNewTodo);
    });
    events.onSaveTodo.map(function (todo) {
        util_1.todoStorage.saveTodo(todo).then(events.saveTodo);
    });
    events.onSetCompleted.map(function (data) {
        util_1.todoStorage.setCompleted(data.todoId, data.completed).then(function () { return events.setCompleted(data); });
    });
};
...
var ESCAPE_KEY = 27;
exports.createActions = function (updates, events) { return ({
    editBlur: function (id) { return function (evt) {
        return events.saveTodo({ id: id, title: evt.currentTarget.value });
    }; },
    editKeyUp: function (id) { return function (evt) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var actions_1 = __webpack_require__(58);
var updates_1 = __webpack_require__(60);
...
var _ = __webpack_require__(1);
exports.createUpdates = function (update) { return ({
    cancelEdit: function () { return update(function (model) {
        return _.set(model, "editTodo", {});
    }); },
    editingTodo: function (id, title) { return update(function (model) {
        return _.set(model, "editTodo", { id: id, title: title });
    }); }
}); };
...
Object.defineProperty(exports, "__esModule", { value: true });
var h_1 = __webpack_require__(0);
exports.createView = function (actions) { return function (todo) {
    return h_1.default("input.edit", {
        attrs: { type: "text" },
        hook: {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.createActions = function (updates, events) { return ({
    deleteTodo: function (todoId) { return function () { return events.deleteTodoId(todoId); }; },
    editTodo: function (todo) { return function () { return updates.editTodo(todo); }; },
    toggleTodo: function (todoId) { return function (evt) {
        return events.setCompleted({ todoId: todoId, completed: evt.target.checked });
    }; }
}); };
...
exports.getTodoClassMap = function (model, todo) { return ({
    completed: todo.completed,
    editing: state_1.state.editing(model, todo)
}); };
exports.getTodoClasses = function (model, todo) {
    return classnames(exports.getTodoClassMap(model, todo));
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var todoEdit_1 = __webpack_require__(59);
var actions_1 = __webpack_require__(62);
var listeners_1 = __webpack_require__(65);
var updates_1 = __webpack_require__(66);
...
exports.todoItem = {
    create: function (update, events) {
        ...
        var actions = actions_1.createActions(updates, events);
        var components = {
            todoEdit: todoEdit_1.todoEdit.create(update, events.todoEdit)
        };
        return view_1.createView(actions, components);
    },
    events: {
        ...
        todoEdit: todoEdit_1.todoEdit.events
    }
};
...
exports.createListeners = function (updates, events) {
    ...
    events.onSetCompleted.map(function (data) { return updates.setCompleted(data.todoId, data.completed); });
};
...
var _ = __webpack_require__(1);
exports.createUpdates = function (update) { return ({
    deleteTodoId: function (todoId) { return update(function (model) {
        delete model.todosById[todoId];
        model.todoIds.splice(model.todoIds.indexOf(todoId), 1);
        return model;
    }); },
    editTodo: function (todo) { return update(function (model) {
        return _.set(model, "editTodo", todo);
    }); },
    setCompleted: function (todoId, completed) { return update(function (model) {
        return _.set(model, ["todosById", todoId, "completed"], completed);
    }); }
}); };
...
var state_1 = __webpack_require__(11);
exports.createView = function (actions, components) { return function (model) { return function (todoId) {
    var todo = model.todosById[todoId];
    var editing = state_1.state.editing(model, todo);
    return h_1.default("li", { class: display_1.getTodoClassMap(model, todo) }, [
        h_1.default("div.view", [
            h_1.default("input.toggle", {
                attrs: { type: "checkbox" },
                on: { change: actions.toggleTodo(todo.id) },
                props: { checked: todo.completed }
            }),
            h_1.default("label", { on: { dblclick: actions.editTodo(todo) } }, todo.title),
            h_1.default("button.destroy", { on: { click: actions.deleteTodo(todo.id) } })
        ]),
