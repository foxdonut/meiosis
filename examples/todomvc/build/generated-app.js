...
exports.compose = function (f1, f2) { return function (x) { return f1(f2(x)); }; };
...
Object.defineProperty(exports, "__esModule", { value: true });
var flyd = __webpack_require__(15);
var app_1 = __webpack_require__(19);
var todo_storage_1 = __webpack_require__(9);
var snabbdom_1 = __webpack_require__(61);
var attributes_1 = __webpack_require__(64);
var class_1 = __webpack_require__(65);
var eventlisteners_1 = __webpack_require__(66);
var props_1 = __webpack_require__(67);
var meiosis_1 = __webpack_require__(68);
...
todo_storage_1.todoStorage.loadAll().then(function (todos) {
    ...
    var applyUpdate = function (model, modelUpdate) { return modelUpdate(model); };
    var model = flyd.scan(applyUpdate, initialModel, update);
    var app = app_1.createApp(update);
    var viewModel = model.map(app.state);
    var element = document.getElementById("app");
    viewModel.map(function (state) { return render(element, app.view(state)); });
    var router = app.createRouter();
    viewModel.map(router.routeSync);
    meiosis_1.trace({ update: update, dataStreams: [model, viewModel] });
    var meiosisTracer = __webpack_require__(70);
...
var main_1 = __webpack_require__(29);
var router_1 = __webpack_require__(43);
var state_1 = __webpack_require__(57);
var actions_1 = __webpack_require__(58);
var updates_1 = __webpack_require__(59);
var view_1 = __webpack_require__(60);
var createAppRouter = function (update) {
    var updates = updates_1.createUpdates(update);
    var actions = actions_1.createActions(updates);
    return router_1.createRouter(actions);
};
exports.createApp = function (update) {
    var updates = updates_1.createUpdates(update);
    var actions = actions_1.createActions(updates);
    var components = {
        footer: footer_1.createFooter(update, actions),
        header: header_1.createHeader(update),
        main: main_1.createMain(update, updates)
    };
    return {
        view: view_1.createView(components),
        state: state_1.state,
        createRouter: function () { return createAppRouter(update); }
    };
};
...
exports.createFooter = function (update, parentActions) { return ({
    view: view_1.createView(parentActions)
}); };
...
exports.createView = function (actions) { return function (model) {
    return h_1.default("footer.footer", [
        ...
        h_1.default("ul.filters", [
            ...
            h_1.default("li", h_1.default("a", { attrs: { href: "javascript://" }, on: { click: function () { return actions.filter("completed"); } },
...
var updates_1 = __webpack_require__(26);
var view_1 = __webpack_require__(28);
exports.createHeader = function (update) {
    var updates = updates_1.createUpdates(update);
    var actions = actions_1.createActions(updates);
    return {
        view: view_1.createView(actions)
    };
};
...
var ENTER_KEY = 13;
exports.createActions = function (updates) {
    var saveNewTodo = function (rawTitle) {
        var title = rawTitle.trim();
        if (title) {
            util_1.todoStorage.saveTodo({ title: title }).then(updates.saveNewTodo);
        }
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var _ = __webpack_require__(1);
var todoItem_1 = __webpack_require__(30);
var actions_1 = __webpack_require__(40);
var updates_1 = __webpack_require__(41);
var view_1 = __webpack_require__(42);
exports.createMain = function (update, parentUpdates) {
    var updates = _.extend({}, updates_1.createUpdates(update), parentUpdates);
    var actions = actions_1.createActions(updates);
    var components = {
        todoItem: todoItem_1.createTodoItem(update, updates)
    };
    return {
        view: view_1.createView(actions, components)
    };
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var todoEdit_1 = __webpack_require__(31);
var actions_1 = __webpack_require__(35);
var updates_1 = __webpack_require__(36);
var view_1 = __webpack_require__(37);
exports.createTodoItem = function (update, parentUpdates) {
    var updates = updates_1.createUpdates(update);
    var actions = actions_1.createActions(updates);
    var components = {
        todoEdit: todoEdit_1.createTodoEdit(update, parentUpdates)
    };
    return {
        view: view_1.createView(actions, components)
    };
...
var updates_1 = __webpack_require__(33);
var view_1 = __webpack_require__(34);
exports.createTodoEdit = function (update, parentUpdates) {
    var updates = _.extend({}, updates_1.createUpdates(update), parentUpdates);
    var actions = actions_1.createActions(updates);
    return {
        view: view_1.createView(actions)
...
var ENTER_KEY = 13;
var ESCAPE_KEY = 27;
exports.createActions = function (updates) { return ({
    editBlur: function (id) { return function (evt) {
        return util_1.todoStorage.saveTodo({ id: id, title: evt.currentTarget.value }).then(updates.updateTodo);
    }; },
    editKeyUp: function (id) { return function (evt) {
        ...
        if (evt.keyCode === ESCAPE_KEY || evt.which === ESCAPE_KEY) {
            ...
            if (editing && todo.title) {
                util_1.todoStorage.saveTodo(todo).then(updates.updateTodo);
            }
        }
        else {
...
var util_1 = __webpack_require__(2);
exports.createActions = function (updates) { return ({
    deleteTodo: function (todoId) { return function () { return util_1.todoStorage.deleteTodoId(todoId).then(function () { return updates.deleteTodoId(todoId); }); }; },
    editTodo: function (todo) { return function () { return updates.editTodo(todo); }; },
    toggleTodo: function (todoId) { return function (evt) {
        return util_1.todoStorage.setCompleted(todoId, evt.target.checked).then(function (data) { return updates.setCompleted(todoId, evt.target.checked); });
    }; }
}); };
...
Object.defineProperty(exports, "__esModule", { value: true });
var h_1 = __webpack_require__(0);
var display_1 = __webpack_require__(38);
...
var util_1 = __webpack_require__(2);
exports.createActions = function (updates) { return ({
    toggleAllTodos: function (evt) {
        return util_1.todoStorage.setAllCompleted(evt.target.checked).then(updates.displayTodos);
    }
}); };
...
exports.createView = function (actions, components) { return function (model) {
    return h_1.default("section.main", [
        ...
        h_1.default("ul.todo-list", model.todoIds.map(components.todoItem.view(model)))
    ]);
}; };
...
var createBrowserHistory_1 = __webpack_require__(50);
var _ = __webpack_require__(1);
exports.createRouter = function (actions) {
    ...
    var routes = {
        "/": function () { return actions.filter(""); },
        "/active": function () { return actions.filter("active"); },
        "/completed": function () { return actions.filter("completed"); }
    };
    var resolveRoute = function (route) {
        var resolved = urlMapper.map(route, routes);
        if (resolved) {
            var action = resolved.match;
            action();
        }
    };
    ...
    var routeSync = function (model) {
        var route = "/" + model.filterBy;
        if (document.location.hash.substring(1) !== route) {
            history.push("#" + route, { sync: true });
        }
    };
    return { routeSync: routeSync };
};
...
var compileRoute = __webpack_require__(46)
...
var URLON = __webpack_require__(47)
...
var util_1 = __webpack_require__(2);
exports.createActions = function (updates) { return ({
    loadAll: function () { return util_1.todoStorage.loadAll().then(updates.displayTodos); },
    filter: function (by) {
        var updateFn = function (todos) {
            return updates.update(util_1.compose(updates.displayTodosFn(todos), updates.filterFn(by)));
        };
        if (by) {
            util_1.todoStorage.filter(by).then(updateFn);
        }
        else {
            util_1.todoStorage.loadAll().then(updateFn);
        }
    },
    clearCompleted: function () { return util_1.todoStorage.clearCompleted().then(updates.displayTodos); }
}); };
...
Object.defineProperty(exports, "__esModule", { value: true });
var displayTodosFn = function (todos) { return function (model) {
    model.todoIds = [];
    model.todosById = {};
    todos.forEach(function (todo) {
        model.todoIds.push(todo.id);
...
var filterFn = function (by) { return function (model) {
    model.filterBy = by;
    return model;
}; };
exports.createUpdates = function (update) { return ({
    update: update,
    displayTodosFn: displayTodosFn,
    displayTodos: function (todos) { return update(displayTodosFn(todos)); },
    filterFn: filterFn,
    filter: function (by) { return update(filterFn(by)); }
}); };
...
var vnode_1 = __webpack_require__(7);
var is = __webpack_require__(8);
var htmldomapi_1 = __webpack_require__(62);
...
var h_1 = __webpack_require__(0);
exports.h = h_1.h;
var thunk_1 = __webpack_require__(63);
