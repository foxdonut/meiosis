...
var nest = function nest(update, path) {
  return function (modelUpdate) {
    return update(function (model) {
      return _lodash2.default.update(model, path, modelUpdate);
    });
  };
};

var EntryNumber = function (_React$Component) {
  _inherits(EntryNumber, _React$Component);
    ...
    value: function componentWillMount() {
      ...
      var updates = {
        editEntryValue: function editEntryValue(value) {
          return update(function (model) {
            return _lodash2.default.set(model, "value", value);
          });
        }
      };
...
var EntryDate = function (_React$Component2) {
  _inherits(EntryDate, _React$Component2);
  ...
  _createClass(EntryDate, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement("input", { type: "text", size: "10", value: model.value, onChange: actions.editDateValue })
      );
    }
  }], [{
    key: "model",
    ...
    value: function componentWillMount() {
      ...
      var updates = {
        increase: function increase(value) {
          return update(function (model) {
            return _lodash2.default.update(model, "value", function (v) {
              return v + value;
            });
          });
        },
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "form",
        null,
        _react2.default.createElement(EntryNumber, { model: model.entry, update: nests.entry }),
        _react2.default.createElement(EntryDate, { model: model.date, update: nests.date }),
        _react2.default.createElement(Temperature, { model: model.temperature.air, update: nests.temperature.air }),
        _react2.default.createElement(Temperature, { model: model.temperature.water, update: nests.temperature.water }),
        _react2.default.createElement(
          "div",
          null,
          _react2.default.createElement(
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(131), __webpack_require__(335)(module)))
