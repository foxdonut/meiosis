...
var _books = __webpack_require__(523);

var _bookDetails2 = __webpack_require__(521);
...
var _bookSummary2 = __webpack_require__(522);
...
var _coffee = __webpack_require__(537);

var _books = __webpack_require__(523);

var _bookSummary = __webpack_require__(522);

var _bookDetails = __webpack_require__(521);
...
var _pathToRegexp = __webpack_require__(504);
...
var createRouter = exports.createRouter = function createRouter(update) {
  ...
  var noRender = function noRender() {
    return null;
  };

  var createRouteResolver = function createRouteResolver(component) {
    return {
      onmatch: function onmatch(params) {
        return component.display(update, params);
      },
      render: noRender
    };
  };
  ...
  var routeResolvers = Object.keys(routes).reduce(function (acc, next) {
    acc[next] = createRouteResolver(routes[next]);
    return acc;
  }, {});

  _mithril2.default.route(stub, "/", routeResolvers);
  ...
  var routeSync = function routeSync(model) {
    ...
    var route = _pathToRegexp2.default.compile(segment)(model.params || {});
