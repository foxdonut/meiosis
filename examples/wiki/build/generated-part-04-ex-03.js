...
var _services = __webpack_require__(434);
...
var _app = __webpack_require__(435);

var _router = __webpack_require__(440);
...
var _coffee = __webpack_require__(437);

var _beer = __webpack_require__(438);

var _beerDetails = __webpack_require__(439);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } /** @jsx m */
...
exports.createCoffee = undefined;
...
exports.createBeerDetails = undefined;
...
var _pathToRegexp = __webpack_require__(441);
...
var createRouter = exports.createRouter = function createRouter(navigation) {
  ...
  var createRouteResolver = function createRouteResolver(resolved) {
    return {
  ...
  var routes = {
    ...
    "/coffee": { id: _navigation.pages.coffee.id, action: navigation.navigateToCoffee },
  ...
  var routeResolvers = Object.keys(routes).reduce(function (result, next) {
  ...
  var routeMap = Object.keys(routes).reduce(function (result, next) {
    result[routes[next].id] = next;
    return result;
  }, {});

  // Workaround for Mithril not supporting optional parameters
  routeMap[_navigation.pages.coffee.id] = "/coffee/:id?";
