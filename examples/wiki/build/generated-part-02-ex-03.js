...
/******/ 	return __webpack_require__(__webpack_require__.s = "./part-02/03/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.createTemperature = undefined;\n\nvar _actions = __webpack_require__(/*! ./actions */ \"./part-02/03/temperature/actions.js\");\n\nvar _view2 = __webpack_require__(/*! ./view */ \"./part-02/03/temperature/view.jsx\");\n\nvar createTemperature = exports.createTemperature = function createTemperature(update) {\n  var computed = function computed(model) {\n    var temp = model.value;\n\n    if (model.units === \"F\") {\n      temp = Math.round((temp - 32) * 5 / 9);\n    }\n    model.comment = temp < 10 ? \"COLD!\" : temp > 40 ? \"HOT\" : \"\";\n\n    return model;\n  };\n\n  var _view = (0, _view2.createView)((0, _actions.createActions)(update));\n\n  return {\n    model: function model() {\n      return {\n        date: \"\",\n        value: 20,\n        units: \"C\"\n      };\n    },\n\n    view: function view(model) {\n      return _view(computed(model));\n    }\n  };\n};\n\n//# sourceURL=webpack:///./part-02/03/temperature/index.js?");

/***/ }),

/***/ "./part-02/03/temperature/view.jsx":
/*!*****************************************!*\
  !*** ./part-02/03/temperature/view.jsx ***!
  \*****************************************/
/*! no static exports found */
