...
var update = _flyd2.default.stream(); /* global ReactDOM */
...
var _view = __webpack_require__(405);

var _temperature = __webpack_require__(406);

var _nest = __webpack_require__(409);
  ...
  return {
    editDate: function editDate(evt) {
      return update(function (model) {
        return model.set("date", evt.target.value);
      });
    },
    ...
    changeUnits: function changeUnits() {
      return update(function (model) {
        return model.get("units") === "C" ? model.set("units", "F").set("value", Math.round(model.get("value") * 9 / 5 + 32)) : model.set("units", "C").set("value", Math.round((model.get("value") - 32) / 9 * 5));
      });
    }
  };
};
  ...
  return function (model) {
    return React.createElement(
      ...
      React.createElement(
        ...
        null,
        "Date: ",
        React.createElement("input", { type: "text", size: "10", value: model.get("date"), onChange: actions.editDate })
      ),
      React.createElement(
        "span",
        null,
...
var nestUpdate = exports.nestUpdate = function nestUpdate(update, path) {
  return function (modelUpdate) {
    return update(function (model) {
      return model.update(path, modelUpdate);
    });
  };
};
