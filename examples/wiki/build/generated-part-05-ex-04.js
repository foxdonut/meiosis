...
var assoc = exports.assoc = function assoc(prop, value) {
...
var merge = exports.merge = function merge(source) {
...
var bookDetails = exports.bookDetails = {
  page: {
    id: "BookDetails",
    tab: "Books"
  },
  create: function create(_update) {
    return function (model) {
      return model.params.id ? (0, _mithril2.default)("p", "Details of book " + model.params.id) : null;
    };
  },
  display: function display(update, params) {
    return update((0, _util.merge)({ page: bookDetails.page, params: params }));
  }
};
...
exports.bookSummary = undefined;

var _mithril = __webpack_require__(214);

var _mithril2 = _interopRequireDefault(_mithril);

var _books = __webpack_require__(520);

var _bookDetails2 = __webpack_require__(518);

var _util = __webpack_require__(509);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var bookSummary = exports.bookSummary = {
  page: {
    id: "BookSummary",
    tab: "Books"
  },
  create: function create(update) {
    var components = {
      books: _books.books.create(update)
    };
    var actions = {
      bookDetails: function bookDetails(id) {
        return function () {
          return _bookDetails2.bookDetails.display(update, { id: id });
        };
      }
    };

    return function (model) {
      return [components.books(model), (0, _mithril2.default)("p", "Summary of book " + model.params.id), (0, _mithril2.default)("a[href='#/books/" + model.params.id + "/details']", "View details"), (0, _mithril2.default)("span", " "), (0, _mithril2.default)("button.btn.btn-default.btn-xs", { onclick: actions.bookDetails(model.params.id) }, "View details")];
    };
  },
  display: function display(update, params) {
    return update((0, _util.merge)({ page: bookSummary.page, params: params }));
  }
};
...
var _bookSummary2 = __webpack_require__(519);
...
var books = exports.books = {
  ...
  create: function create(update) {
    var actions = {
      bookSummary: function bookSummary(id) {
        return function () {
          return _bookSummary2.bookSummary.display(update, { id: id });
        };
      }
    };

    return function (model) {
      return (0, _mithril2.default)("div", (0, _mithril2.default)("p", "Book Page"), (0, _mithril2.default)("ul", model.books.map(function (book) {
        return (0, _mithril2.default)("li", { key: book.id }, (0, _mithril2.default)("a[href='#/books/" + book.id + "']", book.title), (0, _mithril2.default)("span", " "), (0, _mithril2.default)("button.btn.btn-default.btn-xs", { onclick: actions.bookSummary(book.id) }, book.title));
      })));
    };
  },
  display: function display(update, params) {
    return update((0, _util.merge)({ page: books.page, params: params }));
  }
};
...
var coffee = exports.coffee = {
  ...
  create: function create(update) {
    var actions = {
      coffeeDescription: function coffeeDescription(id) {
        return function () {
          return coffee.display(update, { id: id });
        };
      }
    };

    return function (model) {
      return (0, _mithril2.default)("p", "Coffee Page", (0, _mithril2.default)("ul", model.coffees.map(function (coffee) {
        return (0, _mithril2.default)("li", { key: coffee.id }, (0, _mithril2.default)("a[href='#/coffee/" + coffee.id + "']", coffee.description), (0, _mithril2.default)("span", " "), (0, _mithril2.default)("button.btn.btn-default.btn-xs", { onclick: actions.coffeeDescription(coffee.id) }, coffee.description));
      })), model.params.id ? (0, _mithril2.default)("div", "Description of coffee " + model.params.id) : null);
    };
  },
  display: function display(update, params) {
    return update((0, _util.merge)({ page: coffee.page, params: params }));
  }
};
...
var home = exports.home = {
  ...
  create: function create(_update) {
    return function (_model) {
      return (0, _mithril2.default)("div", "Home Page");
    };
  },
  display: function display(update) {
    return update((0, _util.assoc)("page", home.page));
  }
};
...
var pathToRegexp = _interopDefault(__webpack_require__(504));
...
var _coffee = __webpack_require__(535);

var _books = __webpack_require__(520);

var _bookSummary = __webpack_require__(519);

var _bookDetails = __webpack_require__(518);
...
var app = exports.app = {
  model: function model() {
    return {
      page: _home.home.page,
      params: {},
      coffees: [{ id: "c1", description: "Coffee 1" }, { id: "c2", description: "Coffee 2" }],
      books: [{ id: "b1", title: "Book 1" }, { id: "b2", title: "Book 2" }]
    };
  },

  create: function create(update) {
    var pageMap = [_home.home, _coffee.coffee, _books.books, _bookSummary.bookSummary, _bookDetails.bookDetails].reduce(function (acc, next) {
      acc[next.page.id] = next.create(update);
      return acc;
    }, {});

    return function (model) {
      var currentPageId = pageMap[model.page.id] ? model.page.id : _home.home.page.id;
      var currentTab = model.page.tab;
      var page = pageMap[currentPageId];
      var isActive = function isActive(tab) {
        return tab === currentTab ? ".active" : "";
      };

      return (0, _mithril2.default)("div", (0, _mithril2.default)("nav.navbar.navbar-default", (0, _mithril2.default)("ul.nav.navbar-nav", (0, _mithril2.default)("li" + isActive(_home.home.page.id), (0, _mithril2.default)("a[href='#/']", "Home")), (0, _mithril2.default)("li" + isActive(_coffee.coffee.page.id), (0, _mithril2.default)("a[href='#/coffee']", "Coffee")), (0, _mithril2.default)("li" + isActive(_books.books.page.id), (0, _mithril2.default)("a[href='#/books']", "Books")), (0, _mithril2.default)("li.btn", (0, _mithril2.default)("button.btn.btn-default", { onclick: function onclick() {
          return _home.home.display(update);
        } }, "Home")), (0, _mithril2.default)("li.btn", (0, _mithril2.default)("button.btn.btn-default", { onclick: function onclick() {
          return _coffee.coffee.display(update, {});
        } }, "Coffee")), (0, _mithril2.default)("li.btn", (0, _mithril2.default)("button.btn.btn-default", { onclick: function onclick() {
          return _books.books.display(update, {});
        } }, "Books")))), page(model));
    };
  }
};
...
var _universalRouter = __webpack_require__(539);

var _universalRouter2 = _interopRequireDefault(_universalRouter);

var _generateUrls = __webpack_require__(581);
...
var createRouter = exports.createRouter = function createRouter(update) {
  var routes = [{ path: "/", name: _home.home.page.id,
    action: function action() {
      return _home.home.display(update);
    }
  }, { path: "/coffee/:id?", name: _coffee.coffee.page.id,
    action: function action(ctx) {
      return _coffee.coffee.display(update, ctx.params);
    }
  }, { path: "/books", children: [{ path: "/", name: _books.books.page.id,
      action: function action(ctx) {
        return _books.books.display(update, ctx.params);
      }
    }, { path: "/:id", name: _bookSummary.bookSummary.page.id,
      action: function action(ctx) {
        return _bookSummary.bookSummary.display(update, ctx.params);
      }
    }, { path: "/:id/details", name: _bookDetails.bookDetails.page.id,
      action: function action(ctx) {
        return _bookDetails.bookDetails.display(update, ctx.params);
      }
    }] }];
  ...
  var routeSync = function routeSync(model) {
    var route = urlGenerator(model.page.id, model.params || {});
    if (document.location.hash.substring(1) !== route) {
      window.history.pushState({}, "", "#" + route);
    }
  };

  return { resolveRoute: resolveRoute, routeSync: routeSync };
};
...
var _router = __webpack_require__(546);
...
var view = _app.app.create(update);
models.map(function (model) {
  return _mithril2.default.render(element, view(model));
});

// Router
var router = (0, _router.createRouter)(update);
...
var Router = _interopDefault(__webpack_require__(539));
