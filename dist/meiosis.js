...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var createFeature = function createFeature(config) {
	  ...
	  var action$ = new _rx.BehaviorSubject(null);
	  ...
	  var sendAction = function sendAction(action) {
	    return new _data2.default(function (rej, res) {
	      return res(action$.onNext(action));
	    });
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(8)(module), (function() { return this; }()), __webpack_require__(5)))
