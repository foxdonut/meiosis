 ...
 * ```
 */
export declare type RouteConfig = Record<string, string>;
/**
 ...
 */
export declare type RouteMatcher<M> = (url: string) => M;
/**
 ...
 */
export declare type ConvertMatch<M> = (match: M) => ({
    page: string;
    params: Params;
});
/**
 ...
 */
export declare type QueryStringParse = (query: string) => Params;
/**
 ...
 */
export declare type QueryStringStringify = (query: Params) => string;
/**
 ...
 */
export declare type QueryStringLib = {
 ...
 * @returns the route.
 */
export declare type ToRoute = (page: string, params?: Params) => Route;
/**
 ...
 * @returns the URL.
 */
export declare type ToUrl = (page: string, params?: Params) => string;
export declare type GetStatePath = (path: string) => string;
/**
 ...
 */
export declare type OnRouteChange = (route: Route) => void;
/**
 * Function to start the router.
 *
 * @param onRouteChange callback function for when the route changes.
 */
export declare type Start = (onRouteChange: OnRouteChange) => any;
export declare type SyncLocationBarParams = {
    page: string;
    params?: Params;
    replace?: boolean;
};
 ...
 */
export declare type SyncLocationBar = (syncLocationBarParams: SyncLocationBarParams) => void;
/**
 ...
 */
export declare type DecodeURI = (uri: string) => string;
/**
 ...
 */
export declare type PushState = (state: any, title: string, url: string) => void;
/**
 * Built-in callback function when the location changes.
 *
 * @param event the event.
 */
export declare type Onpopstate = (event: any) => void;
/**
 ...
 * @param options
 */
export declare type AddEventListener = (type: string, listener: any, options: any) => any;
/**
 * Built-in callback function to remove an event listener.
 */
export declare type RemoveEventListener = (type: string, listener: any) => any;
/**
 ...
 * @template M the matched route type.
 */
export declare type RouterConfig<M> = {
